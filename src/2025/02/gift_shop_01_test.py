""" Test for Gift Shop - Part 1 """
from gift_shop_01 import get_solution, format_data, populate_ranges
...
def test_solution():
    ...
    assert get_solution(populate_ranges(format_data(DATA))) == 1227775576
